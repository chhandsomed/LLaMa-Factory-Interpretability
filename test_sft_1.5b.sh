...
accelerate launch --config_file platform_default_config.yaml.multi src/train_bash.py \
    ...
    --template qwen3 \
    --model_name_or_path /home/huggingface_cache/hub/models--Qwen--Qwen2.5-3B/snapshots/3aab1f1954e9cc14eb9509a215f9e5ca08227a9b \
    ...
    --cutoff_len 2048 \
    --output_dir output/test_sft_qwen2.5-3b \
    --num_train_epochs 10 \
